    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-sm-6 col-sm-offset-3">
          ...
          <div class="box-body">
            <form class="form-horizontal create_stock" role="form" method="POST" action="<?php echo e(url('/stock/store')); ?>">
                        ...
                        <div class="col-sm-12">
                          <div class="form-group">
                            ...
                            <option selected="" disabled="" value=""> Select </option>
                              ...
                              <?php $__currentLoopData = $supplier_details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
